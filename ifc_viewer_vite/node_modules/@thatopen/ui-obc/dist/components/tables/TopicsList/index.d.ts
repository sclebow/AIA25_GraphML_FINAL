...
import { BCFTopicsUI } from "./src/template";
/**
 ...
 */
export declare const topicsList: (state: BCFTopicsUI, autoUpdate?: boolean) => [element: BUI.Table<BUI.TableRowData>, update: BUI.UpdateFunction<BCFTopicsUI>, currentState: () => BCFTopicsUI];
